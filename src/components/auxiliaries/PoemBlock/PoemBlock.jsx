            ...
            <article className={"poem-block "} onDoubleClick={handleLike}>
                ...
                <footer className="footer">
                    <div className="support">
                        <span>
                            <span className={"sup-icon " + ((currentUser && documentLive.likedBy.includes(currentUser.email) && !props.contentEditable) ? "heart-done" : "heart")} onClick={handleLike} >
                                <FaHeart />
                                <p>{props.contentEditable ? 0 : documentLive.likes}</p>
                            </span>
                            <br />
                            <span className={"sup-icon " + ((currentUser && documentLive.bookmarkedBy.includes(currentUser.email) && !props.contentEditable) ? "bookmark-done" : "bookmark")} onClick={handleBookmark}>
                                <FaBookmark />
                                <p>{props.contentEditable ? 0 : documentLive.bookmarks}</p>
                            </span>
                            <br />
